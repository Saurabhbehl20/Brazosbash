...
@section('content')
@if(! have_posts())
<section class="not_fount_section pt-56 pb-32 pattern-bg">
    <div class="container mx-auto">
    <h3 class="tracking-wider text-3xl font-normal tk-modesto-poster pb-5 uppercase text-center pt-14"><span class="color-red">Sorry</span>, no results were found</h3>
</section>
@endif
@if(have_posts())
  <section class="blog-section pattern-bg pt-56 pb-16 bg-repeat-x bg-top bg-auto lg:bg-no-repeat lg:bg-cover relative px-5 xl:px-0">
    <div class="container mx-auto">
